    ...
    public class Class1
    {
        ...
        public class ExtendedDictionary<Key, Value1, Value2>
        {
            ...
            public void Add(Key key, Value1 val1, Value2 val2)
            {
                ...
                line.key = key; line.value1 = val1; line.value2 = val2; dict.Add(line);
            }
            ...
            {
                int iss = 0; int ind = 0; for (int i = 0; i < dict.Count; i++)
                {
                    if (object.Equals(dict[i].key, elem)) { iss++; ind = i; }
                }
                if (iss == 0) Console.WriteLine("Key does not exist"); else Console.WriteLine($"Key exist - index:{ind}");
            }
            ...
            public void ExistValues(Value1 val1, Value2 val2)
            {
                ...
                else Console.WriteLine($"Val1 and Val2 is not exist");
            }
